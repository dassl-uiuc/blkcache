...
/**
 * ThreadSafeLRUAccessRateCache is a thread-safe hashtable with a limited size. When
...
class ThreadSafeLRUAccessRateCache {
  /**
   * The LRU list node.
   *
...
public:
   ...
   */
  explicit ThreadSafeLRUAccessRateCache(size_t maxSize, BlockCacheConfig block_cache_config_, std::shared_ptr<RDMAKeyValueStorage> rdma_key_value_storage_);

  ThreadSafeLRUAccessRateCache(const ThreadSafeLRUAccessRateCache& other) = delete;
  ThreadSafeLRUAccessRateCache& operator=(const ThreadSafeLRUAccessRateCache&) = delete;

  ~ThreadSafeLRUAccessRateCache() {
    clear();
  }
...
typename ThreadSafeLRUAccessRateCache<TKey, TValue, THash>::ListNode* const
ThreadSafeLRUAccessRateCache<TKey, TValue, THash>::OutOfListMarker = (ListNode*)-1;

template <class TKey, class TValue, class THash>
ThreadSafeLRUAccessRateCache<TKey, TValue, THash>::
ThreadSafeLRUAccessRateCache(size_t maxSize, BlockCacheConfig block_cache_config_, std::shared_ptr<RDMAKeyValueStorage> rdma_key_value_storage_)
...
template <class TKey, class TValue, class THash>
inline void ThreadSafeLRUAccessRateCache<TKey, TValue, THash>::
